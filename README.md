...
## [](#模板引擎-templating-)模板引擎( Templating )
...
## [](#静态站生成器-static-site-generators-)静态站生成器( Static Site Generators )
...
## [](#结构-architectural-)结构( Architectural )
...
## [](#调试和性能-debugging-and-profiling-)调试和性能( Debugging and Profiling )
...
## [](#地理定位-geolocation-)地理定位( Geolocation )
...
## [](#日期与时间-date-and-time-)日期与时间( Date and Time )
...
*   [Webmozart Console](https://github.com/JingwenTian/awesome-php/blob/master/github.com/webmozart/console)

## [](#定时任务-crontab-)定时任务( Crontab )
...
## [](#身份验证-authentication-and-authorization-)身份验证( Authentication and Authorization )
...
## [](#过滤和验证-filtering-ang-validation-)过滤和验证( Filtering ang Validation )
...
## [](#国际化和本地化internationalisation-and-localisation)国际化和本地化(Internationalisation and Localisation)
...
## [](#php-安装php-installation)PHP 安装(PHP Installation)
...
## [](#开发环境development-environment)开发环境(Development Environment)
...
## [](#虚拟机virtual-machines)虚拟机(Virtual Machines)
...
## [](#开发工具integrated-development-environment)开发工具(Integrated Development Environment)
...
## [](#web-应用程序web-applications)Web 应用程序(Web Applications)
...
## [](#基础设施infrastructure)基础设施(Infrastructure)

> 提供PHP应用程序和服务的基础设施

*   [appserver.io](http://appserver.io/) - 基于PHP的多线程应用程序服务器

## [](#数据库中间件-db-proxy-)数据库中间件( DB Proxy )
...
## [](#异步网络通信框架-asynchronous-event-driven-framework-)异步网络通信框架( Asynchronous Event Driven Framework )
